...
async def checkout_customer(queue: Queue, cashier_number: int):
    ...
    while not queue.empty():
        ...
        print(f"The Cashier_{cashier_number} "
              ...
              f"in {round(time.perf_counter() - product.checkout_time, ndigits=2)} secs")
...
# # 2	       | 10	        | 3		      |         2.04          |          10.18   
# # 5	       | 10	        | 4			  |         2.03          |          6.11     
# # 5	       | 20			| 5           |         2.06          |          >= 8 s (8.1 s)
# # +--------|------------|-------------|-----------------------|------------------------- 

 # 
# # +------------|-------|--------|-----------------------------------------------------|-------|    
  # |Customer   | Queue | Cashier|  Customers/time by Cashier                           |Toyal  |
  # |---------------------------------------------------------------------------|-------|-------|
  # |           |       |        | C |  o  | C | 1   | C |  2  | C |   3   |  c |   4   |       |
  # |---------------------------------------------------------------------------|-------|-------|
  ...
  # |---------------------------------------------------------------------------|-------|-------|
  # |    10     |   3   |   5    | 4 | 8.0s| 3 | 6.0s|   |     |   |       |    |       | 8.02s |
  # |---------------------------------------------------------------------------|-------|-------|
  # |    20     |   5   |   5    | 4 | 8.0s| 4 | 8.0s| 4 | 8.0s| 4 | 8.0s  | 4  |  8.0s | 8.1 s |
  # |---------------------------------------------------------------------------|-------|-------|
